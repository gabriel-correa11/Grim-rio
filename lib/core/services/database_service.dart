...
class DatabaseService {
  ...
  Future<bool> updateUserProgressAfterQuiz(String userId, int score,
      int totalQuestions, bool isFirstCompletion, int baseXp) async {
    final userRef = _db.collection('users').doc(userId);
    final xpGained = isFirstCompletion ? score * baseXp : (score * baseXp / 2).round();
